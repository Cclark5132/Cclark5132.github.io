  ...
  return (
    <main id="main-content" className="technical-grid grid min-h-[80vh] place-items-center px-5 pt-24 text-center">
      <div>
        ...
        <h1 className="mt-4 text-5xl font-semibold tracking-[-0.06em] text-charcoal md:text-7xl">Page not found.</h1>
        <p className="mx-auto mt-4 max-w-lg text-base leading-7 text-steel">Return to the portfolio to see Charles's work and contact information.</p>
