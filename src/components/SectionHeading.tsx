  ...
  return (
    <header className="mb-8 flex flex-col gap-4 border-t-2 border-cyan pt-5 md:mb-10 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        <h2 className="max-w-4xl text-balance text-3xl font-semibold tracking-[-0.045em] text-white sm:text-4xl md:text-5xl">{title}</h2>
      </div>
      {description && <p className="max-w-md text-pretty text-base leading-7 text-white/65">{description}</p>}
    </header>
  );
}
